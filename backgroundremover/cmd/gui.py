...
def main():
    ...
    #aap start my code. Wrapped in a loop and prompt for files
    args.transparentvideo = True #manually set this since we're not using cli
    args.workernodes = 3
    args.gpubatchsize = 3
    input_files = filedialog.askopenfilenames(title="Video")
    output_format = ".mov"
    ...
    for input_file in input_files:
        with open(input_file, "rb") as input:
            ...
            output = os.path.join(str(filepath.parent),filepath.stem + "_background_removed" + output_format)
